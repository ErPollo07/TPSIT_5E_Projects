...
#define PROGRESS_BAR_SPACE 20

#define WATER_HEATER_TIME 2
...
int main()
{
    ...
    Beverage b[] = {
        ...
        {5, "Tè caldo", 80, 120},
        {6, "Acqua calda", 90, 50}};
    int lenOfBeverage = sizeof(b) / sizeof(Beverage);

    const int TOTAL_MENU = STATIC_OPTIONS + lenOfBeverage + 1;
    ...
    beverageToMenu(MAIN_MENU, STATIC_OPTIONS, TOTAL_MENU - 1, b, lenOfBeverage);
    ...
    while (g_continue)
    {
        ...
        int choice = menuChoice(TOTAL_MENU - 2); // Tolgo il posto del titolo e exit
        ...
        default:
            ...
            progressBar(timeForPreparation);
